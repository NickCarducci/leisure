...
class InflationAsset extends React.Component {
  state = {};
        ...
        >
          {!isNaN(width) && (
            <iframe
              ...
              src={`https://fred.stlouisfed.org/graph/graph-landing.php?g=IYow&width=${width}&height=700`}
              style={{
                border: "none",
                position: "relative",
                width: width,
